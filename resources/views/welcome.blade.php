...
<body class="antialiased">
  <div class="relative max-w-xl flex flex-col items-center justify-center mx-auto min-h-screen gap-8">
        ...
        <div class="mb-6">
          ...
          <div class="flex items-center justify-center w-full">
            <label for="dropzone-file"
              ...
              <input id="dropzone-file" type="file" class="hidden" name="profile_photo" />
            </label>
          </div>
